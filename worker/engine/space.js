...
*/
exports.meina = async(img, prompt, negativePrompt, model) => {
return new Promise(async(resolve, reject) => {
 try{  
  let a = await axios('https://app.yimeta.ai/ai-pose-generator/run/predict',
   {
   method: 'POST',
   data: {
    "data": [
    "data:image/jpg;base64," + img.toString('base64'),
     model,
     negativePrompt,
     7,
     "0"
    ...
    "event_data": null,
    "fn_index": 6,
    "session_hash": "g7wc5obdcun"
   }
   })   
   console.log(a)
   resolve(a["data"]["data"][0][0]["name"]) 
  } catch (e){ 
    reject(e)
  }
 })
...
return new Promise(async(resolve, reject) => {
  ...
  let azfir = await axios('https://doevent-face-real-esrgan.hf.space/run/predict',
   ...
   data: {  
          ...
          "session_hash":"loyvyj2omj8"
       }                            
   })
    console.log(azfir.data.detail)
